package com.dartmouth.cs.intersection.AudioAnalyze.audio;
...
public class MicrophoneRecorder extends Thread {
    ...
    public void run() {
        try {
            ...
            int bufferSize = 200;//frequency;//AudioRecord.getMinBufferSize(frequency, channelConfiguration, audioEncoding);
    ...
    private final float mRecordingGain = 1000;
